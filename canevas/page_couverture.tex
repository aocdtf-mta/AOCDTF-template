...
%--------------------------------------
	...
	\begin{tikzpicture}[remember picture, overlay]
		...
		\draw (5,-14) node [right, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}\showmatiere}}}; %intitulé de la matière
		\draw (20,-16) node [left, opacity=0.7] {\sffamily\textls[150]{\Huge\textbf{\color{bleulogo}\showcours}}}; %intitulé du cours
...
%--------------------------------------
	...
	\begin{tikzpicture}[remember picture, overlay]
		\begin{scope}[shift={(current page.north west)}]
			...
			node [opacity=0.3] {\includegraphics[width=8cm]{choix_blason}};
		\end{scope}
	\end{tikzpicture}
